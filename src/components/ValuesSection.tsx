...
import { staggerContainer, rotateIn, titleReveal } from "@/lib/motion";
      ...
      >
        {values.map((v) => (
          <motion.div
            ...
            className="flex items-start gap-4 bg-card rounded-xl p-5 border transition-all duration-300 hover:shadow-md"
          >
            <motion.div
